                    ...
                    <>
                        <div className={"flex items-center gap-8 portrait:justify-between"}>
                            ...
                            <div className={"portrait:text-right"}>
                                <div className={"flex gap-3 portrait:justify-end"}>
                                    <h2 className={"!text-3xl font-bold portrait:!text-2xl"}>{filament.vendor}</h2>
                                    <h2 className={"!text-3xl font-extralight portrait:hidden"}>#{filament.id}</h2>
                                </div>
                                <h2 className={"hidden !text-3xl font-extralight portrait:!text-xl portrait:block"}>#{filament.id}</h2>
                                <h2 className={"font-medium portrait:!text-xl"}>{filament.material}</h2>
                            </div>
                        </div>
                        <div
                        ...
                        <div className={"flex gap-16 portrait:flex-col portrait:items-center"}>
                            <img src={filament.image_url}
                                 className={"border custom-border w-128 h-128 aspect-square object-cover p-8 portrait:w-80 portrait:h-80 portrait:p-4"}
                                 alt=""/>
                                ...
                                <div className={"flex flex-col gap-3 portrait:items-center"}>
                                    ...
                                    <table className={"info-table w-max"}>
                                        ...
                                        <tr className={"portrait:hidden"}>
                                            <td
                                                className={"flex mt-4 justify-center items-center cursor-pointer border rounded-lg border-red-600 hover:bg-red-600/10 select-none"}
                                                onClick={() => {
                                                    setShowDelete(true)
                                                }}
                                            >
                                                <img className={"w-8 -ml-2"} src="/src/images/delete_red.png"
                                                     alt=""/>
                                                <p>Odstrániť</p>
                                            </td>
                                        </tr>
                                    ...
                                    <div
                                        className={"hidden portrait:flex justify-center items-center gap-2 w-full border border-red-600 py-4 rounded-xl hover:bg-red-600/10 select-none"}
                                        onClick={() => {
                                            setShowDelete(true)
                                        }}
                                    >
                                        <img className={"w-8"} src="/src/images/delete_red.png" alt=""/>
                                        <p>Odstrániť</p>
                                    </div>
                                </div>
                                {
