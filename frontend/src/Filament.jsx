...
function Filament() {
  ...
  useEffect(() => {
    axios
      .get(`http://${IP}:5000/api/v1/filaments/${id}/`)
      .then((response) => {
      ...
      {responseCode === 200 ? (
        <>
          <div className={"flex items-center gap-8 portrait:justify-between"}>
            <img
              className={"h-24"}
              src={`http://${IP}:5000/api/v1/images/qr/${id}.png`}
              alt=""
            />
                ...
                <table className={"info-table w-max"}>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <b>
                          {Math.max(filament.weight - filament.weight_spool, 0)}{" "}
                          g
                        </b>
                      </td>
                      <EditFilament
